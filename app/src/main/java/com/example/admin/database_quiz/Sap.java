...
import com.example.admin.database_quiz.db.DBAdapter_Sap;
...
public class Sap extends AppCompatActivity {   //Asp Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DBAdapter_Sap dbAdapter = new DBAdapter_Sap(this);
            ...
            public void onClick(View v) {
                ...
                if (answer != null) {
                    ...
                    if (questionId < dbAdapter.rowCount()) {
                        ...
                        Intent intent = new Intent(Sap.this, ResultActivity.class);
