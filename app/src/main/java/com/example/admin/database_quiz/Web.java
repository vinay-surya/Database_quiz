...
import com.example.admin.database_quiz.db.DBAdapter_Web;
...
public class Web extends AppCompatActivity {   //Asp Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DBAdapter_Web dbAdapter = new DBAdapter_Web(this);
            ...
            public void onClick(View v) {
                ...
                if (answer != null) {
                    ...
                    if (questionId < dbAdapter.rowCount()) {
                        ...
                        Intent intent = new Intent(Web.this, ResultActivity.class);
