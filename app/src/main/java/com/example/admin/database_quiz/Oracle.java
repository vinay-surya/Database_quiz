...
import com.example.admin.database_quiz.db.DBAdapter_Oracle;
...
public class Oracle extends AppCompatActivity {   //Asp Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DBAdapter_Oracle dbAdapter = new DBAdapter_Oracle(this);
            ...
            public void onClick(View v) {
                ...
                if (answer != null) {
                    ...
                    if (questionId < dbAdapter.rowCount()) {
                        ...
                        Intent intent = new Intent(Oracle.this, ResultActivity.class);
