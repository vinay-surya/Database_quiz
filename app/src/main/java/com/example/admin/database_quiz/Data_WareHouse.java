...
import com.example.admin.database_quiz.db.DBAdapter_Asp;
import com.example.admin.database_quiz.db.DBAdapter_Data_WareHouse;
import com.google.android.gms.ads.AdRequest;
import com.google.android.gms.ads.AdView;
import com.example.admin.database_quiz.db.DBAdapter;
import com.example.admin.database_quiz.model.Question;

import java.util.ArrayList;
import java.util.List;

public class Data_WareHouse extends AppCompatActivity {   //Data Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data__ware_house);
        ...
        final DBAdapter_Data_WareHouse dbAdapter = new DBAdapter_Data_WareHouse(this);
            ...
            public void onClick(View v) {
                ...
                if (answer != null) {
                    ...
                    if (questionId < dbAdapter.rowCount()) {
                        ...
                        Intent intent = new Intent(Data_WareHouse.this, ResultActivity.class);
