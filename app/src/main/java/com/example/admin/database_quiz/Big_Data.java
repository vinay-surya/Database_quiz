...
import com.example.admin.database_quiz.db.DBAdapter_Big_Data;
...
public class Big_Data extends AppCompatActivity {   //Big Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DBAdapter_Big_Data dbAdapter = new DBAdapter_Big_Data(this);
            ...
            public void onClick(View v) {
                ...
                if (answer != null) {
                    ...
                    if (questionId < dbAdapter.rowCount()) {
                        ...
                        Intent intent = new Intent(Big_Data.this, ResultActivity.class);
