...
import java.util.List;
    ...
    public class Asp extends AppCompatActivity {   //Asp Activity
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            final DBAdapter_Asp dbAdapter = new DBAdapter_Asp(this);
                ...
                public void onClick(View v) {
                    ...
                    if (answer != null) {
                        ...
                        if (questionId < dbAdapter.rowCount()) {
                            ...
                            Intent intent = new Intent(Asp.this, ResultActivity.class);
