...
import com.example.admin.database_quiz.db.DBAdapter_Software;
...
public class Software extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DBAdapter_Software dbAdapter = new DBAdapter_Software(this);
            ...
            public void onClick(View v) {
                ...
                if (answer != null) {
                    ...
                    if (questionId < dbAdapter.rowCount()) {
                        ...
                        Intent intent = new Intent(Software.this, ResultActivity.class);
