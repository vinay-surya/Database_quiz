...
import com.example.admin.database_quiz.db.DBAdapter_Devops;
...
public class Devops extends AppCompatActivity {   //Asp Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DBAdapter_Devops dbAdapter = new DBAdapter_Devops(this);
            ...
            public void onClick(View v) {
                ...
                if (answer != null) {
                    ...
                    if (questionId < dbAdapter.rowCount()) {
                        ...
                        Intent intent = new Intent(Devops.this, ResultActivity.class);
